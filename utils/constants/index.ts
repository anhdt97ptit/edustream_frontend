...
export const CLASS_STATUS_BADGE = {
  [CLASS_STATUS.OPEN]: {
    variant: "success",
    text: "Hoạt động",
  },
...
export type TReferrerStatus =
  (typeof REFERRER_STATUS)[keyof typeof REFERRER_STATUS];
